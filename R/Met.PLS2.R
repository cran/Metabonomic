...
function(datos,externa)
{
  ...
  {
 Met.PLS2.multi(datos,externa)
  }
  if (is.character(clase3)==TRUE & is.character(clase4)==TRUE)
  {
  Met.PLS2.multi2(datos,externa)
  }
...
{
par(bg=color)
plot(d,xlab=xlab,ylab=ylab,main=main,sub=subt,cex.axis=size$cex.axis,
